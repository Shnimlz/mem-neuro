...
[Service]
ExecStart=/home/YourName/Github/llama.cpp/build/bin/llama-server -m /home/YourName/Path/to/models/YourModel.gguf -c 4096 --port 8080 --host 127.0.0.1
Restart=on-failure
...
[Service]
ExecStart=/home/YourName/Github/llama.cpp/build/bin/llama-server -m /home/YourName/Path/to/models/YourModel.gguf --port 8081 --host 127.0.0.1 --embeddings --pooling mean
Restart=on-failure
...
[Service]
WorkingDirectory=/home/YourName/Github/mem-neuro/cerebro_unificado/backend
ExecStart=/home/YourName/Github/mem-neuro/cerebro_unificado/backend/.venv/bin/python3 main.py
Restart=on-failure
...
Alternativamente, puedes usar el script de control `cerebro.sh` en la raíz del repositorio:
```bash
# Encender todos los servicios
./cerebro.sh start

# Apagar todos los servicios temporalmente
./cerebro.sh stop

# Reiniciar todos los servicios
./cerebro.sh restart

# Apagar y desactivar permanentemente (evita el inicio automático al arrancar)
./cerebro.sh disable
